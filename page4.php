	...
	<div data-role="page" id="page1">
		<div class="theme-preview">
			...
			<div class="ui-body ui-body-a" data-role="content">
				...
				<p>This is the page for the third candidate!</p>
				
				<p><img src="images/Johnny.jpg" /></p>
				<?
					...
					if ($canvote == 1)
					{
						...
						print "<p><input name='action' type='submit' data-ajax=\"false\" value='Vote for Johnny'></p>";
						print "</form>";
					}
					else
					{
