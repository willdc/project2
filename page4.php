						...
						print '
							...
							<div data-role="page" id="page1">
								...
								<div class="ui-body ui-body-a" data-role="content">
									<h3>Johnny Bravo</h3> 
										<p>Now remember, I do my best work when I\'m being worshipped as a god. But enough about me, now let\'s talk about... me. </p>
								...
								while($row=$result->fetch_object()){
									if($row->voted == 0){//LOGGED IN HASNT VOTED
										...
										while($row = $totalresult->fetch_object()) 
										{
											...
											{
												print "<p>Votes for Johnny Bravo: ".$row->total."</p><br />";
											}
...
print '<div data-role="controlgroup">
                        ...
                        <a href="page3.php?idnumber='.$idnumber.'&name='.$name.'"\" data-role="button" data-inline="false" data-mini="true" data-ajax="false" data-icon="arrow-r" data-iconpos="right">Buzz Lightyear</a></ul>
                  </div>      
                	';
